...
<article class="page-container">
    <form action="/role/edit" method="post" class="form form-horizontal" id="form-admin-role-add">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <div class="radio-box">
                    <input name="roleType" type="radio" id="roleType-1" value="1" ${role.roleType == 1 ? "checked" : ""}>
                    <label for="roleType-1">普通管理员</label>
                </div>
                <div class="radio-box">
                    <input name="roleType" type="radio" id="roleType-2" value="0" ${role.roleType == 0 ? "checked" : ""}>
