...
<header class="navbar-wrapper">
    <div class="navbar navbar-fixed-top">
        <div class="container-fluid cl"> <a class="logo navbar-logo f-l mr-10 hidden-xs" href="/index">政通监控系统</a>
...
<aside class="Hui-aside">
    <div class="menu_dropdown bk_2">
        <c:forEach items="${menus}" var="main">
            <dl>
                <dt><i class="Hui-iconfont">&#xe616;</i> ${main.name}<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
                <dd>
                    <ul>
                        <c:forEach items="${main.submenu}" var="secondMenu" >
                            <li><a data-href="${secondMenu.url}" data-title="${secondMenu.name}" href="javascript:void(0)">${secondMenu.name}</a></li>
                        </c:forEach>
        ...
        <%--<dl id="menu-user">--%>
            ...
            <%--<dd>--%>
                <%--<ul>--%>
                    <%--<li><a data-href="/resource/list" data-title="资源管理" href="javascript:void(0)">资源管理</a></li>--%>
