...
public class HttpUtil {
    ...
    /**
     * 发送 POST 请求（HTTP），x-www-form-urlencoded形式
     * @param apiUrl API接口URL
     * @param formData 键值对
     * @encode 请求编码
     * @return
     */
    public String doPost(String apiUrl, String formData, String encoding) {
        CloseableHttpClient httpClient = HttpClients.createDefault();
        String httpStr = null;
        HttpPost httpPost = new HttpPost(apiUrl);
        CloseableHttpResponse response = null;
        ...
        try {
            httpPost.setConfig(requestConfig);
            StringEntity stringEntity = new StringEntity(formData,encoding);//解决中文乱码问题
            stringEntity.setContentEncoding("UTF-8");
    ...
    /**
     * 发送 SSL POST 请求（HTTPS），x-www-form-urlencoded形式
     * @param apiUrl API接口URL
     * @param formData 键值对
     * @encode 请求编码
     * @return
     */
    public String doPostSSL(String apiUrl, String formData, String encoding) {
        CloseableHttpClient httpClient = HttpClients.custom().setSSLSocketFactory(createSSLConnSocketFactory()).setConnectionManager(connMgr).setDefaultRequestConfig(requestConfig).build();
        HttpPost httpPost = new HttpPost(apiUrl);
        CloseableHttpResponse response = null;
        String httpStr = null;
